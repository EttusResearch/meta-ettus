...
FILES:${PN}-firmware:ni-titanium = " \
    ...
    /lib/firmware/x420.bin \
    /lib/firmware/x420.dtbo \
...
do_install:append:ni-titanium() {
    ...
    mv ${D}/lib/firmware/${DEFAULT_BITFILE_NAME_X420}.bin ${D}/lib/firmware/x420.bin
    mv ${D}/lib/firmware/${DEFAULT_BITFILE_NAME_X420}.dtbo ${D}/lib/firmware/x420.dtbo
